...
def mostrar_subgrupos_y_cuentas_por_grupo(grupo_id):
    ...
    with sqlite3.connect(ruta_BD) as conn:
        ...
        for subgrupo_id, descripcion_subgrupo in subgrupos:
            print(f"  Subgrupo ID: {subgrupo_id}, Descripción: {descripcion_subgrupo}")
            ...
            if cuentas:
                for cod_3, desc_3 in cuentas:
                    print(f"    - Código: {cod_3}, Descripción: {desc_3}")
            else:
...
def Insertar_Datos_Iniciales():
    ...
    insertar_datos_grupo(ruta_BD, "PRODCTOS FINANCIEROS")
    ...
    insertar_datos_subgrupo(ruta_BD, 1, "Self Banc")
    ...
    insertar_datos_subgrupo(ruta_BD, 1, "T.R.Publicidad")
    insertar_datos_subgrupo(ruta_BD, 1, "Bestinver")
    insertar_datos_subgrupo(ruta_BD, 1, "Bufete Perez Pozo")
    insertar_datos_subgrupo(ruta_BD, 1, "Kontactalia")
    insertar_datos_subgrupo(ruta_BD, 1, "Inversiones en empresas")
    insertar_datos_subgrupo(ruta_BD, 1, "Carmon Inversores")
    ...
    insertar_datos_subgrupo(ruta_BD, 1, "Minto")
    insertar_datos_subgrupo(ruta_BD, 2, "Deudas Familiares")
    insertar_datos_subgrupo(ruta_BD, 2, "Deudas Casa")
    insertar_datos_subgrupo(ruta_BD, 2, "Otras Deudas")
    insertar_datos_subgrupo(ruta_BD, 3, "Gastos Fijos")
    insertar_datos_subgrupo(ruta_BD, 3, "Gastos Variables")
    insertar_datos_subgrupo(ruta_BD, 3, "Gastos Extraordinarios")
    insertar_datos_subgrupo(ruta_BD, 4, "Salarios")
    insertar_datos_subgrupo(ruta_BD, 4, "Inversiones")
    ...
    insertar_datos_cuenta(ruta_BD, 1, 16, "Crowfunding")    
