...
empresa = app.main.empresa
BasedeDatos = app.main.BasedeDatos
ruta_BD = app.main.ruta_BD
...
def insertar_datos_grupo(descripcion_grupo):
    ...
    Args:
        ruta_BD (str): Ruta de la base de datos.
...
def mostrar_subgrupos_y_cuentas_por_grupo(grupo_id):
    """
...
def Insertar_Datos_Iniciales():
    ...
    insertar_datos_grupo( "PRODCTOS FINANCIEROS")
    insertar_datos_grupo( "DEUDAS")
    insertar_datos_grupo( "GASTOS")
    insertar_datos_grupo( "INGRESOS")

    # Insertar datos en SUBGRUPO (Nivel 2)
    insertar_datos_subgrupo(1, "Caixa Enginyers")
    insertar_datos_subgrupo(1, "Self Banc")
    insertar_datos_subgrupo(1, "DeGiro")
    insertar_datos_subgrupo(1, "Santander")
    insertar_datos_subgrupo(1, "Stockcrowd")
    insertar_datos_subgrupo(1, "Civislend")
    insertar_datos_subgrupo(1, "T.R.Publicidad")
    insertar_datos_subgrupo(1, "Bestinver")
    insertar_datos_subgrupo(1, "Bufete Perez Pozo")
    insertar_datos_subgrupo(1, "Kontactalia")
    insertar_datos_subgrupo(1, "Inversiones en empresas")
    insertar_datos_subgrupo(1, "Carmon Inversores")
    insertar_datos_subgrupo(1, "Trade Republic")
    insertar_datos_subgrupo(1, "B Sabadell")
    insertar_datos_subgrupo(1, "BBVA")
    insertar_datos_subgrupo(1, "Minto")
    insertar_datos_subgrupo(2, "Deudas Familiares")
    insertar_datos_subgrupo(2, "Deudas Casa")
    insertar_datos_subgrupo(2, "Otras Deudas")
    insertar_datos_subgrupo(3, "Gastos Fijos")
    insertar_datos_subgrupo(3, "Gastos Variables")
    insertar_datos_subgrupo(3, "Gastos Extraordinarios")
    insertar_datos_subgrupo(4, "Salarios")
    insertar_datos_subgrupo(4, "Inversiones")
    insertar_datos_subgrupo(4, "Otros Ingresos")

    # Insertar datos en CUENTAS (Nivel 3)
    insertar_datos_cuenta(1, 1, "Cta.Cte.")
    insertar_datos_cuenta(1, 1, "Depósitos")
    insertar_datos_cuenta(1, 1, "Fondos Inv.")
    insertar_datos_cuenta(1, 1, "Cta.Cte. $")
    insertar_datos_cuenta(1, 1, "Depósitos $")
    insertar_datos_cuenta(1, 2, "Cta.Cte.")
    insertar_datos_cuenta(1, 2, "Cta. Remunerada")
    insertar_datos_cuenta(1, 2, "Depósitos")
    insertar_datos_cuenta(1, 2, "Fondos Inv.")
    insertar_datos_cuenta(1, 2, "F.Inv. Cta.Cte.")
    insertar_datos_cuenta(1, 4, "Cta.Cte.")
    insertar_datos_cuenta(1, 4, "Renta Variable")
    insertar_datos_cuenta(1, 4, "Derivados Financieros")
    insertar_datos_cuenta(1, 3, "Cta.Cte.")
    insertar_datos_cuenta(1, 3, "Renta Variable")
    insertar_datos_cuenta(1, 3, "ETF")
    insertar_datos_cuenta(1, 5, "Cta.Cte.")
    insertar_datos_cuenta(1, 5, "Crowfunding")
    insertar_datos_cuenta(1, 6, "Cta.Cte.")
    insertar_datos_cuenta(1, 6, "Crowfunding")
    insertar_datos_cuenta(1, 7, "Crowfunding")
    insertar_datos_cuenta(1, 8, "Plan Pensiones")
    insertar_datos_cuenta(1, 8, "Fondos Inv.")
    insertar_datos_cuenta(1, 9, "Crowfunding")
    insertar_datos_cuenta(1, 10, "CapitalCell")
    insertar_datos_cuenta(1, 10, "Cebiotec")
    insertar_datos_cuenta(1, 11, "Crowfunding")
    insertar_datos_cuenta(1, 12, "Cta.Cte.")
    insertar_datos_cuenta(1, 12, "Depósitos")
    insertar_datos_cuenta(1, 13, "Cta.Cte.")
    insertar_datos_cuenta(1, 13, "Depósitos")    
    insertar_datos_cuenta(1, 14, "Cta.Cte.")
    insertar_datos_cuenta(1, 14, "Depósitos")    
    insertar_datos_cuenta(1, 15, "Cta.Cte.")
    insertar_datos_cuenta(1, 15, "Depósitos") 
    insertar_datos_cuenta(1, 16, "Crowfunding")    
    insertar_datos_cuenta(2, 1, "Roger")
    insertar_datos_cuenta(2, 1, "Enric")
    insertar_datos_cuenta(2, 2, "Enaire 0%")
    insertar_datos_cuenta(2, 3, "Inversiones JMG")
    insertar_datos_cuenta(2, 3, "Avis")
    insertar_datos_cuenta(2, 3, "Tata")
    insertar_datos_cuenta(2, 3, "Albert")
    insertar_datos_cuenta(2, 3, "Joan Moises")
    insertar_datos_cuenta(3, 1, "Comida")
    insertar_datos_cuenta(3, 1, "Agua")
    insertar_datos_cuenta(3, 1, "Luz")
    insertar_datos_cuenta(3, 1, "Gas")
    insertar_datos_cuenta(3, 1, "Teléfono/Internet")
    insertar_datos_cuenta(3, 1, "Limpieza")
    insertar_datos_cuenta(3, 1, "Comunidad Vecinos")
    insertar_datos_cuenta(3, 1, "Otros Gastos Fijos")
    insertar_datos_cuenta(3, 2, "Ropa")
    insertar_datos_cuenta(3, 2, "Salud")
    insertar_datos_cuenta(3, 2, "Transporte")
    insertar_datos_cuenta(3, 2, "Seguros")
    insertar_datos_cuenta(3, 2, "Impuestos")
    insertar_datos_cuenta(3, 2, "Vacaciones")
    insertar_datos_cuenta(3, 2, "Otros Gastos Variables")
    insertar_datos_cuenta(3, 3, "Gastos Extraordinarios")
    insertar_datos_cuenta(3, 3, "Otros Gastos Extraordinarios")
    insertar_datos_cuenta(3, 3, "Cuadrar Saldos")
    insertar_datos_cuenta(4, 1, "Montse")
    insertar_datos_cuenta(4, 1, "Carlos")
    insertar_datos_cuenta(4, 1, "Pensión")
    insertar_datos_cuenta(4, 2, "Bancarios")
    insertar_datos_cuenta(4, 2, "Renta Fija")
    insertar_datos_cuenta(4, 2, "Renta Variable")
    insertar_datos_cuenta(4, 2, "Fondos Inv.")
    insertar_datos_cuenta(4, 2, "Crowfunding")
    insertar_datos_cuenta(4, 3, "Otros Ingresos")

#Crear_Tablas()
#Insertar_Datos_Iniciales()
#mostrar_datos_cuentas()
#mostrar_datos_subgrupo()
#mostrar_subgrupos_y_cuentas_por_grupo(1)
